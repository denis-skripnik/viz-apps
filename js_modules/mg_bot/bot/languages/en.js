...
Play games and earn points. Once a day, there will be a distribution of awards from the Viz account among those who receive points in proportion to them at 12:00 Moscow time.
...
Your boost: ${boost_percent}%!

Learn about Viz and create an account: https://start.viz.world`;
    },
...
"too_fast": "⏳ Too fast, wait a bit.",
    
    "boosts": "Boosts",
"boosts_text": `Unlike many current tap bots, @viz_mg_bot boosts your points automatically:
1. Add $VIZ to the first or last name of your Telegram account, and get +10% to your points accrued in games
2. Add @viz_mg_bot to the name or surname of akka, and get another +20% to the points you receive
3. Add VIZ login to the bot by clicking the "Specify Viz login" button, and get another +10% to the points awarded!
4. Play as many different games as possible today, and get extra. Boost!
+2% to points for each game. That is, if you played 5 games today, there will be +10% to points!
Important: for betting on the BTC rate, the bonus increases only if you win!
5. And if you awarded the bot with >= 1 VIZ, you will receive an additional 2% boost!

Go to this section: there may be more boosts in the future.`,
...
"games": "Games",
    ...
    "scores_top_text": function(top_list) {
        return `List of participants with points greater than 0 (pay attention to the energy percentage: if it is less than 0.01, you will not receive a reward; only 20% is distributed per day according to the recovery rate):
${top_list}`;
        },
...
${top_list}`;
              ...
              "t_xp_top": "Top Tamagotchi Experience",
              "t_xp_top_text": function(top_list) {
                  return `List of participants based on Tamagotchi experience:
${top_list}`;
                 },
...
"viz_scores_adding": function(to, memo) {
    return `Send the reward via the Viz blockchain to receive Viz points (✖10 to the amount of the reward received). You will not be able to receive a reward from them at 12:00 Moscow time until you use them in games, for example, betting on the crypto exchange rate. If you win, you will receive real points.
...
"viz_login_text": `Enter your Viz login. You can find it at https://info.viz.world, https://viz.dpos.space. Register at @viz_social_bot or here: https://start.viz.world. For questions about Viz, contact @viz_support`,
...
If you win, you will receive up to *1.2 to your points + bonus. The multiplier decreases as you gain points in the bot (at least +5% of the bet).
...
"cb_more": "Higher",
"cb_less": "Lower",
"crypto_bids_ok": "Bid accepted. Wait for the results in 1 minute.",
...
The source of the rate: Binance`;
},
...
"yes_scores_award": `Hooray! You have accumulated the required number of points to receive the award!
You will see it either on the balance of the Viz account (the bot will transfer the amount), or in @viz_social_bot.
The delivery will occur after sending messages to the participants.`,
